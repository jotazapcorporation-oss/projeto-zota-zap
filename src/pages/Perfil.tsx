...
export default function Perfil() {
  ...
  return <div className="max-w-6xl mx-auto p-6 space-y-8 animate-fade-in">
      {/* Header com Avatar */}
      ...
      <Tabs defaultValue="profile" className="w-full">
        ...
        <TabsContent value="profile" className="space-y-6">
          <Card className="hover-lift">
            ...
            <CardContent>
              <ProfileEditor profile={profile} onProfileUpdate={setProfile} currentCountryCode={currentCountryCode} currentPhoneNumber={currentPhoneNumber} onCountryChange={handleCountryChange} onPhoneChange={handlePhoneChange} />
            </CardContent>
          </Card>
        </TabsContent>
                  ...
                  <AlertDialogContent>
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Input id="confirm-email" type="email" placeholder="Confirme seu email" value={confirmEmail} onChange={e => setConfirmEmail(e.target.value)} />
                      </div>
                    </div>

                    <AlertDialogFooter>
                      <AlertDialogCancel onClick={() => setConfirmEmail("")}>Cancelar</AlertDialogCancel>
                      <AlertDialogAction onClick={handleDeleteAccount} disabled={deleting || confirmEmail !== user?.email} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
